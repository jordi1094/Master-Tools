...
describe('registerUser', () => {
    ...
    it('succes on user registered',() =>
        registerUser('test', 'teando','test@teando.com','testeando','master','123123123', '123123123')
            .then(User.findOne()
                .then(user => {
    ...
    it('fails on user already exist', ()=> {
        ...
        return bcrypt.hash('123123123', 8)
            .then(hash => User.create({ name: 'Mac', surname: 'Book', email: 'test@teando.com', username: 'testeando',role:'master', password: hash }))
            .then(
                registerUser('test', 'teando','test@teando.com','testeando','master', '123123123', '123123123')
    ...
    it('fails on invalid name',() => {
        ...
        try {
            registerUser(432423, 'teando','test@teando.com','testeando','master', 123123123, '123123123')
        } catch (error) {
            errorThrown = error
        } finally{
    ...
    it('fails on invalid surname',() => {
        ...
        try {
            registerUser('test', 5432,'test@teando.com','testeando','master', '123123123', '123123123')
        } catch (error) {
            errorThrown = error
        } finally{
            expect(errorThrown).to.be.instanceOf(ContentError)
    ...
    it('fails on invalid email',() => {
        ...
        try {
            registerUser('test', 'teando',65434,'testeando','master', '123123123', '123123123')
        } catch (error) {
            errorThrown = error
        } finally{
            expect(errorThrown).to.be.instanceOf(ContentError)
    ...
    it('fails on invalid username',() => {
        ...
        try {
            registerUser('test', 'teando','test@teando.com',5432,'master', '123123123', '123123123')
        } catch (error) {
            errorThrown = error
        } finally{
            expect(errorThrown).to.be.instanceOf(ContentError)
    ...
    it('fails on pasword and pasword repeat don\'t match',() => {
        ...
        try {
            registerUser('test', 'teando','test@teando.com','testeando','master', '123123123', '156432653452')
        } catch (error) {
            errorThrown = error
        } finally{
